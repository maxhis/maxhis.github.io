...
![](/images/simulate-location-4.png)

导入后，就可以正式修改位置了，进入上一步同样的菜单，只是这次选中导入的文件：

![](/images/simulate-location-5.png)
